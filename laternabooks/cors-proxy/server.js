...
const COURIERPLUS_BASE_URL = process.env.COURIERPLUS_BASE_URL || "https://demo.client-api.courierplus-ng.com/api/v1/client";
const COURIERPLUS_TOKEN = process.env.COURIERPLUS_TOKEN || "249|9NfX2ufAkelB2mJjSMOPXi57dTx8X2OLPu9Tz5st9ezOmt6YZwWMvQbzCXkn2F01YWX4RNhBG5wVBLMUB1wviGwMpyQzQaQImSzemB5iUKZ7OZnnsXeEuNxNQKRgyKdsoQf0pCLsz6i1DRchx0VsnxmHyuqFGMyGdjoUbmlBvBhZfWVlhq2g3dnFohHCgsKI2giqAx3Rqc9ympWU1Yf1wUzn593LFc2zemWuVvl09FhRlQm2SC2OfKf5vh";
...
app.post("/api/courierplus/tariff/get-tariff", async (req, res) => {
  const url = `${COURIERPLUS_BASE_URL}/tariff/get-tariff`;

  const result = await safeFetch(url, {
    method: "POST",
    headers: {
      Authorization: `Bearer ${COURIERPLUS_TOKEN}`,
    },
    body: req.body,
  });
...
app.post("/api/shop/order/confirm", async (req, res) => {
  const url = `${EXTERNAL_BASE_URL}/api/v1/shop/order/confirm`;
