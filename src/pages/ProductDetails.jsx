...
// ✅ Use Vercel proxy URL or fallback to localhost
const API_BASE =
  import.meta.env.VITE_API_BASE_URL || "http://localhost:3001/api/proxy";
...
const ProductDetails = () => {
  ...
  const { name, base_price, in_stock, description, image_url, attributes, sku } = product;
                  ...
                  <div className="mb-10">
                    ...
                    <div className="divide-y divide-gray-100 rounded-xl border border-gray-100 overflow-hidden">
                      {attributes.map((attr, i) => (
                        ...
                        >
                          <span className="text-gray-500 text-sm">{attr.name || "Attribute"}</span>
                          <span className="text-gray-900 font-medium text-sm">{attr.value || "N/A"}</span>
                        </div>
                      ))}
                    </div>
                  </div>
